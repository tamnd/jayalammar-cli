...
Most of these come down to network reality or how jayalammar serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jayalammar rate-limits like any public site. jay already paces
...
Where a surface is gated, jay reads a cookie or token you supply
...
`jay`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jay actually did
